...
sinta_judul<-dbGetQuery(DB,"SELECT * FROM judul WHERE accred != 'Unknown'")
View(sinta_judul)


leaderboard_penulis<-dbGetQuery(DB,"
                      with dt1 as 
                      (SELECT *,
                      ...
                      SELECT id_sinta,INITCAP(nama_penulis) AS nama_penulis,nama_dept,nama_instansi,sinta_score_ovr,jumlah_article_scopus 
                      FROM dt1
                      ")
View(leaderboard_penulis)

leaderboard_penulis_sinta<-dbGetQuery(DB,"
                      with dt1 as 
                      (SELECT *,
                      CASE WHEN departemen.nama_departemen='Unknown' then 'Unknown'
                           ELSE split_part(departemen.nama_departemen, '- ', 2) END
                      ...
                      dt2 as(
                       SELECT id_sinta,INITCAP(nama_penulis) AS nama_penulis,nama_dept,nama_instansi,sinta_score_ovr as sinta_score_ovr,jumlah_article_scopus 
                      FROM dt1
                      ),
                      dt3 as(
                      ...
                      LIMIT 10
                      ")
View(leaderboard_penulis_sinta)

leaderboard_penulis_scopus<-dbGetQuery(DB,"
                      with dt1 as 
                      (SELECT *,
                      CASE WHEN departemen.nama_departemen='Unknown' then 'Unknown'
                           ELSE split_part(departemen.nama_departemen, '- ', 2) END
                      ...
                      dt2 as(
                       SELECT id_sinta,INITCAP(nama_penulis) AS nama_penulis,nama_dept,nama_instansi,sinta_score_ovr as sinta_score_ovr,jumlah_article_scopus as jumlah_article_scopus
                      FROM dt1
                      ),
                      dt3 as(
                      ...
                      LIMIT 10
                      ")
View(leaderboard_penulis_scopus)

leaderboard_instansi_sinta<-dbGetQuery(DB,"
                      with dt1 as (
                      ...
                      dt3 as 
                      (SELECT id_sinta,dt2.id_instansi,dt2.nama_instansi,dt2.prov,dt2,kota_kab,sinta_score_ovr,jumlah_article_scopus
                      FROM penulis
                      INNER JOIN dt2 ON penulis.id_instansi=dt2.id_instansi
                      ),
                      dt4 as
                      (SELECT id_instansi,nama_instansi,INITCAP(prov) AS provinsi,INITCAP(kota_kab) AS kab_kota,sinta_score_ovr as sinta_score_ovr,jumlah_article_scopus 
                      FROM dt3
                      ),
                      dt5 as(
                      ...
                      LIMIT 10
                      ")
View(leaderboard_instansi_sinta)

leaderboard_instansi_scopus<-dbGetQuery(DB,"
                      with dt1 as (
                      SELECT *,split_part(lokasi, '-', 1) AS kota_kab,
                               split_part(lokasi, '-', 2) AS provinsi
                      FROM instansi ),
                      ...
                      dt4 as
                      (SELECT id_instansi,nama_instansi,INITCAP(prov) AS provinsi,INITCAP(kota_kab) AS kab_kota,sinta_score_ovr as sinta_score_ovr,jumlah_article_scopus as jumlah_article_scopus 
                      FROM dt3
                      ),
                      dt5 as(
                      ...
                      LIMIT 10
                      ")
View(leaderboard_instansi_scopus)