...
subject<-dbGetQuery(DB,"SELECT *,
                              CASE WHEN lower(subject_list) in ('statistics','statistik','statistika','statistic') then 'Statistika'
                                   ...
                                   WHEN lower(subject_list) like '%komputasi%' or
                                        ...
                                        lower(subject_list) like '%decesion support system%' or
                                   ...
                                   WHEN lower(subject_list) like '%keagamaan%' or
                                    ...
                                    WHEN lower(subject_list) like '%olahraga%' then 'Statistika Olahraga' 
                                    ...
                                    WHEN lower(subject_list) like '%probability%' or
                                        ...
                                        lower(subject_list) like '%mathematics%' then 'statistik'
...
leaderboard_instansi<-dbGetQuery(DB,"
                      with dt1 as (
                      ...
                      SELECT id_instansi,nama_instansi,INITCAP(prov) AS provinsi,INITCAP(kota_kab) AS kab_kota,sinta_score_ovr,jumlah_article_scopus 
                      FROM dt3
                      GROUP BY nama_instansi
                      ORDER BY score_sinta_ovr DESC
                      LIMIT 10
                      ")
View(leaderboard_instansi)